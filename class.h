...
public:
    ASCIICanvas(int width, int height); // wielkosc planszy x to szerokosc y to wysokosc
...
public:
    Figure(int x, int y, char symbol); 
...
public:
    Triangle(int x, int y,char symbol, int base, int height);
...
public:
    Circle(int x, int y,char symbol, int radius);
...
public:
    Rectangle(int x, int y,char symbol, int width, int height);
...
public:
    Square(int x, int y,char symbol, int side);
